...
struct ExperimentData
    ...
    contexts::Vector{Vector{String3}}
    n_subjects::Int
    n_periods::Int
    d_cov::Int
end
...
function ExperimentData(obs, covs, contexts)
...
function prepare_data_with1(input_path::String, output_path::String)
    println("Reading CSV files...")
    df  = CSV.read(input_path, DataFrame; delim=';')
...
function load_data(filepath::String; ID_excluded=Int[])
    ...
    idx = setdiff(1:length(y), ID_excluded)
